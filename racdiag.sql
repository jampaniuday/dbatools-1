...
Ttitle  ' [ Taking Hang Analyze dumps ]'  skip 1
...
Ttitle  ' [ WAITING SESSIONS ]'  skip 1
-- WAITING SESSIONS:
...
Ttitle  ' [ EVENT PARAMETER LOOKUP ]'  skip 1
...
Ttitle  ' [ GES LOCK BLOCKERS ]'  skip 1
-- GES LOCK BLOCKERS:
...
Ttitle  ' [ GES LOCK WAITERS ]'  skip 1
-- GES LOCK WAITERS:
...
Ttitle  ' [ GLOBAL CACHE CR PERFORMANCE ]'  skip 1
...
Ttitle  ' [ GLOBAL CACHE LOCK PERFORMANCE ]'  skip 1
...
Ttitle  ' [ DLM TRAFFIC INFORMATION ]'  skip 1
...
Ttitle  ' [ DLM MISC ]'  skip 1
-- DLM MISC
--
set numwidth 10
select * from gv$dlm_misc;

Ttitle  ' [ LOCK CONVERSION DETAIL ]'  skip 1
...
Ttitle  ' [ TOP 10 WRITE PINGING/FUSION OBJECTS ]'  skip 1
...
Ttitle  ' [ TOP 10 READ PINGING/FUSION OBJECTS ]'  skip 1
...
Ttitle  ' [ TOP 10 FALSE PINGING OBJECTS]'  skip 1
...
Ttitle  ' [ INITIALIZATION PARAMETERS]'  skip 1
...
Ttitle  ' [ TOP 10 WAIT EVENTS ON SYSTEM]'  skip 1
...
Ttitle  ' [ SESSION/PROCESS REFERENCE]'  skip 1
...
Ttitle  ' [ SYSTEM STATISTICS]'  skip 1
-- SYSTEM STATISTICS:
...
Ttitle  ' [ CURRENT SQL FOR WAITING SESSIONS]'  skip 1
