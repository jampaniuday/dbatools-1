...
-- Show SQL text, child cursors and execution stats for SQLID

col sql_sql_text head SQL_TEXT format a150 word_wrap
col sql_child_number head CH# for 999

--prompt Show SQL text, child cursors and execution stats for SQLID and child and
...
-- where 
--         sql_id = ('&&sql_id')
-- and child_number like '&&child_number'
-- order by
--         sql_id,
--         hash_value,
--         child_number
